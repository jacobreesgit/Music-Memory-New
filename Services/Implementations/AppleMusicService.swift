...
//  Updated on 20/05/2025 to conform to AppleMusicServiceProtocol
//
...
actor AppleMusicService: AppleMusicServiceProtocol {
    // MARK: - Properties
    ...
    init() {
        ...
        Task {
            ...
            self.hasAccess = self.authorizationStatus == .authorized
        }
    }
